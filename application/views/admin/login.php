...
<html lang="en">
  <head>
    ...
    <title>Vantage Villa | Login Admin </title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?php echo site_url('adminpanel/login');?>" method="post">
              ...
              <div class="separator">
                <p>Hello Admin! Get Ready to Work in
                </p>
                ...
                <div>
                  <h1><i class="fa fa-home"></i> Vantage Villa</h1>
                  <p>©2023 All Rights Reserved. 
                    <br>Comfortable Place For You is Vantage Villa!</p>
                </div>
              </div>
            </form>
          </section>
